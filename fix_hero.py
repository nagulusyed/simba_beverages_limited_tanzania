...
# 2. Color change: green to brown on the label
for y in range(400, min(865, h)):
    for x in range(w):
        r, g, b, a = data[y, x]
        if a > 0:
...
# 3. Crop the reflection with a curved bottom.
y_check = min(850, h-1)
...
print("Image fully processed and saved.")
